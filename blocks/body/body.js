...
export default async function decorate(doc) {
  const tab = createElement("div",{props:{className:"tab"}});
  const tab_description  = createElement("div", {props:{className:"tab-description"}})
  const tab_additional = createElement("div", {props:{className:"tab-additional"}})
